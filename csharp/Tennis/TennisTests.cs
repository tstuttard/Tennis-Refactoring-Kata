...
namespace Tennis
{
    ...
    public class TennisTests
    {
        ...
        {
            var game = new TennisGame1("player1", "player2", new GameScore("player1", "player2"));
            CheckAllScores(game);
        }
    ...
    public class ExampleGameTennisTest
    {
        ...
        {
            var game = new TennisGame1("player1", "player2", new GameScoreUsingStates("player1", "player2"));
